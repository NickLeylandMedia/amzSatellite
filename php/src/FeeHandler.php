...
class RequestHandler
{
    ...
    */
    ...
    public function createFeeEstimateRequest(float $listing_price_amount, string $id_value, bool $is_amazon_fulfilled = false, string $currency_code = "USD", float $shipping_price_amount = 0.00, string $id_type = IdType::ASIN): bool{
        try{
